...
public class User {
	 ...
	 * `user_name` varchar(64) NOT NULL COMMENT '用户名称', `user_password`
	 * varchar(32) NOT NULL COMMENT '用户密码', `user_state` char(1) NOT NULL
	 * COMMENT '1:正常,0:暂停', PRIMARY KEY (`user_id`) ) ENGINE=InnoDB

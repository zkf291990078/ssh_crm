...
public class Customer {
	 ...
	 * `cust_level` VARCHAR(32) DEFAULT NULL COMMENT '客户级别', `cust_linkman`
	 * VARCHAR(64) DEFAULT NULL COMMENT '联系人', `cust_phone` VARCHAR(64) DEFAULT
	 * NULL COMMENT '固定电话', `cust_mobile` VARCHAR(16) DEFAULT NULL COMMENT
	 * '移动电话', PRIMARY KEY (`cust_id`) ) ENGINE=INNODB AUTO_INCREMENT=1 DEFAULT
	 * CHARSET=utf8;
	 */

										...
										<TBODY>
											...
											<s:iterator value="#pageBean.list" var="linkMan">
												<TR
													...
													<TD><s:property value="#linkMan.lkm_gender=='1'?'男':'女'" /></TD>
							...
							<TR>
								<TD><SPAN id=pagelink>
											<DIV
												...
												<select name="pageSizeSelect" onchange="changePageSize($('#pageSizeSelect option:selected').val())" id="pageSizeSelect" >

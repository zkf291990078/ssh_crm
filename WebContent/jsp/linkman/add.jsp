...
<BODY>
	<FORM id=form1 name=form1
		...
		<input type="hidden" name="lkm_id"
			value="<s:property value="#linkMan.lkm_id" />" />
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property
										value="#linkMan==null?'添加':'修改'" />联系人
								</TD>
							</TR>
							<TR>
								<TD height=2></TD>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<tr>
								...
								<td colspan="3"><input type="hidden"
									name="customer.cust_id" style="WIDTH: 180px" id="cust_id"
									value="<s:property value='#linkMan.customer.cust_id' />" /> <input
									type="text" style="WIDTH: 180px" id="cust_name"
									value="<s:property value='#linkMan.customer.cust_name' />" /> <input
							...
							<TR>
								...
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="lkm_name"
									 value="<s:property value="#linkMan.lkm_name"/>"
								
									></td>
								<td>联系人性别：</td>
								<td><input type="radio" value="1" name="lkm_gender"
									<s:property value="#linkMan.lkm_gender=='1'?'checked':''" />>男
									<input type="radio" value="2" name="lkm_gender"
									<s:property value="#linkMan.lkm_gender=='2'?'checked':''" />>女</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="lkm_phone"
									 value="<s:property value="#linkMan.lkm_phone"/>"></td>
								<td>联系人手机 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="lkm_mobile"
									 value="<s:property value="#linkMan.lkm_mobile"/>"></td>
							</TR>
							<tr>
